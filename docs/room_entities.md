...
<img src="https://raw.githubusercontent.com/ducdt1298/dreame-smart-vacuum/main/docs/media/room_1_entities.png" width="450px">
...
<img src="https://raw.githubusercontent.com/ducdt1298/dreame-smart-vacuum/main/docs/media/rooms_map_1.png" width="350px"><img src="https://raw.githubusercontent.com/ducdt1298/dreame-smart-vacuum/main/docs/media/rooms_map_2.png" width="350px">
...
<img src="https://raw.githubusercontent.com/ducdt1298/dreame-smart-vacuum/main/docs/media/room_3_map_1.png" width="350px"><img src="https://raw.githubusercontent.com/ducdt1298/dreame-smart-vacuum/main/docs/media/room_3_map_2.png" width="350px">
      ...
      card:            
        ...
        {%- if custom_cleaning_mode %}
          - icon: ${vars[13].attributes.icon}
            ...
            tap_action: 
              action: call-service
              service: dreame_smart_vacuum.select_select_next
              service_data:
                entity_id: ${vars[13].entity_id}
            double_tap_action:
              action: call-service
              service: dreame_smart_vacuum.select_select_previous
              service_data:
                entity_id: ${vars[13].entity_id}
            hold_action:
              action: more-info
...
#### <a href="https://github.com/ducdt1298/dreame-smart-vacuum/blob/main/docs/entities.md#select-entities-for-rooms">For more information about room entities</a>
