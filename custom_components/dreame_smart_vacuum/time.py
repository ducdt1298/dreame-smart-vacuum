"""Support for Dreame Smart Vacuum times."""
...
class DreameVacuumTimeEntityDescription(DreameVacuumEntityDescription, TimeEntityDescription):
    """Describes Dreame Smart Vacuum Time entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum time based on a config entry."""
...
class DreameVacuumTimeEntity(DreameVacuumEntity, TimeEntity):
    """Defines a Dreame Smart Vacuum time."""
    ...
    def __init__(
        ...
        """Initialize Dreame Smart Vacuum time."""
    ...
    async def async_set_value(self, value: time) -> None:
        """Set the Dreame Smart Vacuum time value."""
    ...
    def native_value(self):
        """Return the current Dreame Smart Vacuum time value."""
