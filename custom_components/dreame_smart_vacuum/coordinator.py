"""DataUpdateCoordinator for Dreame Smart Vacuum."""
...
class DreameVacuumDataUpdateCoordinator(DataUpdateCoordinator[DreameVacuumDevice]):
    """Class to manage fetching Dreame Smart Vacuum data from single endpoint."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize global Dreame Smart Vacuum data updater."""
