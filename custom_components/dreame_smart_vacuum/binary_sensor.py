"""Support for Dreame Smart Vacuum Binary Sensors."""
...
class DreameVacuumBinarySensorEntityDescription(DreameVacuumEntityDescription, BinarySensorEntityDescription):
    """Describes Dreame Smart Vacuum BinarySensor entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum Binary Sensor based on a config entry."""
...
class DreameVacuumBinarySensorEntity(DreameVacuumEntity, BinarySensorEntity):
    """Defines a Dreame Smart Vacuum Binary Sensor entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum BinarySensor entity."""
