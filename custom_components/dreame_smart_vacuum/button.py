"""Support for Dreame Smart Vacuum buttons."""
...
class DreameVacuumButtonEntityDescription(DreameVacuumEntityDescription, ButtonEntityDescription):
    """Describes Dreame Smart Vacuum Button entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum Button based on a config entry."""
...
class DreameVacuumButtonEntity(DreameVacuumEntity, ButtonEntity):
    """Defines a Dreame Smart Vacuum Button entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum Button entity."""
...
class DreameVacuumShortcutButtonEntity(DreameVacuumEntity, ButtonEntity):
    """Defines a Dreame Smart Vacuum Shortcut Button entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum Shortcut Button entity."""
