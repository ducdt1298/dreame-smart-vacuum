"""Support for Dreame Smart Vacuum numbers."""
...
class DreameVacuumNumberEntityDescription(DreameVacuumEntityDescription, NumberEntityDescription):
    """Describes Dreame Smart Vacuum Number entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum number based on a config entry."""
...
class DreameVacuumNumberEntity(DreameVacuumEntity, NumberEntity):
    """Defines a Dreame Smart Vacuum number."""
    ...
    def __init__(
        ...
        """Initialize Dreame Smart Vacuum number."""
    ...
    async def async_set_native_value(self, value: float) -> None:
        """Set the Dreame Smart Vacuum number value."""
    ...
    def native_value(self) -> int | None:
        """Return the current Dreame Smart Vacuum number value."""
        return self._attr_native_value


class DreameVacuumSegmentNumberEntity(DreameVacuumEntity, NumberEntity):
    """Defines a Dreame Smart Vacuum Segment number."""
    ...
    def __init__(
        ...
        """Initialize Dreame Smart Vacuum Segment Number."""
