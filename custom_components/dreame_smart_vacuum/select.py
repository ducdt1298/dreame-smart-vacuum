"""Support for Dreame Smart Vacuum selects."""
...
class DreameVacuumSelectEntityDescription(DreameVacuumEntityDescription, SelectEntityDescription):
    """Describes Dreame Smart Vacuum Select entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum select based on a config entry."""
...
class DreameVacuumSelectEntity(DreameVacuumEntity, SelectEntity):
    """Defines a Dreame Smart Vacuum select."""
    ...
    def __init__(
        ...
        """Initialize Dreame Smart Vacuum select."""
...
class DreameVacuumSegmentSelectEntity(DreameVacuumEntity, SelectEntity):
    """Defines a Dreame Smart Vacuum Segment select."""
    ...
    def __init__(
        ...
        """Initialize Dreame Smart Vacuum Segment Select."""
    ...
    async def async_select_option(self, option: str) -> None:
        """Set the Dreame Smart Vacuum Segment Select value."""
        if not self.available:
            raise HomeAssistantError("Entity unavailable")
    ...
    def native_value(self) -> str | None:
        """Return the current Dreame Smart Vacuum select value."""
        if self.segment:
