"""Support for Dreame Smart Vacuum switches."""
...
class DreameVacuumSwitchEntityDescription(DreameVacuumEntityDescription, SwitchEntityDescription):
    """Describes Dreame Smart Vacuum Switch entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum switch based on a config entry."""
...
class DreameVacuumSwitchEntity(DreameVacuumEntity, SwitchEntity):
    """Defines a Dreame Smart Vacuum Switch entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum switch entity."""
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        """Turn off the Dreame Smart Vacuum sync receive switch."""
        await self.async_set_state(0)

    async def async_turn_on(self, **kwargs: Any) -> None:
        """Turn on the Dreame Smart Vacuum sync receive switch."""
        await self.async_set_state(1)

    async def async_set_state(self, state) -> None:
        """Turn on or off the Dreame Smart Vacuum sync receive switch."""
