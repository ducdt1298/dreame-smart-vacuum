...
class DreameVacuumCameraEntityDescription(DreameVacuumEntityDescription, CameraEntityDescription):
    """Describes Dreame Smart Vacuum Camera entity."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum Camera based on a config entry."""
...
class DreameVacuumCameraEntity(DreameVacuumEntity, Camera):
    """Defines a Dreame Smart Vacuum Camera entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum Camera entity."""
