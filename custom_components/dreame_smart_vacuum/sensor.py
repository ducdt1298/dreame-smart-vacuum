"""Support for Dreame Smart Vacuum sensors."""
...
async def async_setup_entry(
    ...
    """Set up Dreame Smart Vacuum sensor based on a config entry."""
...
class DreameVacuumSensorEntity(DreameVacuumEntity, SensorEntity):
    """Defines a Dreame Smart Vacuum sensor entity."""
    ...
    def __init__(
        ...
        """Initialize a Dreame Smart Vacuum sensor entity."""
